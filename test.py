'''
Description:
-- this file is a test file to run and test sample codes and practice different methods etc.
'''
...
if __name__ == "__main__":
    ...
    # main_directory = "D:\\UNI\\The Project\\Data working on\\#1002.txt"
    # for file in os.listdir(main_directory):

    traffic_df = pd.read_csv("D:\\UNI\\The Project\\Data working on\\#1002.csv")
    ...
    result.to_excel("D:\\UNI\\The Project\\Data working on\\scats-97-99\\7-Merged With Weather Excels\\#1002.xlsx")
